...
function Get-SuspiciousPatterns {
    return @(
        ...
        [PSCustomObject]@{ Pattern = "freecam"; Level = "Mittel"; Section = "PATTERNS"; Reason = "Kann auf freie Kamera-/Cheat-Client-Funktionen hinweisen." },
        [PSCustomObject]@{ Pattern = "free cam"; Level = "Mittel"; Section = "PATTERNS"; Reason = "Kann auf freie Kamera-/Cheat-Client-Funktionen hinweisen." },
        [PSCustomObject]@{ Pattern = "noclip"; Level = "Mittel"; Section = "PATTERNS"; Reason = "Kann auf freie Kamera- oder No-Clip-Funktionen hinweisen." },
